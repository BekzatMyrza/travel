    ...
    <div style="margin-top:-20px;" id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
              <img class="d-block w-100 " src="https://www.viewholidaytrip.com/images/main-banner/Thailand-Phuket.jpg" alt="First slide" style="height: 400px; ">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://www.ampersandtravel.com/media/55409/maldives-banner-3-.jpg" alt="Second slide" alt="Second slide" style="height: 400px; ">
            </div>
            <div class="carousel-item">
