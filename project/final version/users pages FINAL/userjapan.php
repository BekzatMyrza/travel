    ...
    <div style="margin-top:-20px;" id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
              <img class="d-block w-100 " src="https://www.wowtravelclub.com/wp-content/uploads/2019/03/Japan-banner.jpg" alt="First slide" style="height: 400px; ">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://www.wendywutours.co.nz/resource/upload/1446/discovery-japan-banner.jpg" alt="Second slide" style="height: 400px; ">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://www.nikkoam.com.au/adviser/files/images/strategy/banner-japan-active-value2x.jpg" alt="Third slide" style="height: 400px; ">
            </div>
...
<div class="main">
  ...
  <?php
    ...
    <div class='modal-dialog modal-dialog-centered modal-xl' role='document'  >
        ...
        //////////////////////////
        $sql = "SELECT*FROM countryhotels where hotelcountry = 'Japan'";
