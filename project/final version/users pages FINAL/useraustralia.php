...
<body>
  ...
  <ul>
        ...
        <li style="margin-left: 146px; margin-right: 20px">
    ...
    <div style="margin-top:-20px;" id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
              <img class="d-block w-100 " src="https://www.imagineholidays.com.au/images/2020/05/06/top-banner_aus.jpg" alt="First slide" style="height: 400px; ">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://www.asmex-conference.com.au/wp-content/uploads/Whitsundays_097a-1440x400_c.jpg" alt="Second slide" style="height: 400px; ">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src=" https://www.idp.com/medias/Aus-Banner-P.jpg?context=bWFzdGVyfGltYWdlc3wzNDc1NDR8aW1hZ2UvanBlZ3xpbWFnZXMvaGI1L2g4Mi85OTg2MjM4NDQ3NjQ2LmpwZ3xiNDIxMzkwZjcyNDM0YzI1ODg3Yjk4OTlhNjgxM2YwMDA2NTM2YWE4OTFlZTI0MzJlZjc3MDI0YWJhOWVlNTlm" alt="Third slide" style="height: 400px; ">
            </div>
...
<div class="main">
  ...
  <?php
    ...
    <div class='modal-dialog modal-dialog-centered modal-xl' role='document'  >
        ...
        //////////////////////////
        $result = mysqli_query($conn, "SELECT*FROM countryhotels where hotelcountry = 'Australia'");
        $total = mysqli_num_rows($result);
        if($total != 0) {
          while($row = mysqli_fetch_assoc($result)) {
           
echo"<div class='country' data-aos='fade-up' style='min-height: 85vh'>
      <img src='".$row["hotelphoto"]."' alt='' class='photo'>
      <div class='row info' style='padding: 10px;'>
          <p class='col-8 col-md-8 col-sm-8 col-lg-8' style='font-size: 25px; margin-top: 0px; margin-bottom: -18px'>".$row["hotelname"]."</p>"?>
          <?php 
          ...
          <form class='col-4 col-md-4 col-sm-4 col-lg-4' method='POST' onsubmit='return saveRatings(this);'>
            ...
            <input type='submit' class='form-control' style='height:35px; width: 60px;' value='".$average_ratings."'>
          </form>
...
<footer class="flex">
    <div class="flex1">
        ...
        <div>
          <a class="linkss" href="userislands.php">Travel tours</a>
        </div>
        <div>
          <a class="linkss" href="firstinfo.html">Vacations</a>
        </div>
    </div>
    <div class="flex2">
        <div>
