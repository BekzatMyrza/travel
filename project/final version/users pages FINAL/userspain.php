    ...
    <div style="margin-top:-20px;" id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
              <img class="d-block w-100 " src="https://media.enableholidays.com/file/enablemedia/accessible-accommodation-in-madrid-banner.jpg" alt="First slide" style="height: 400px; ">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://media.enableholidays.com/file/enablemedia/accessible-accommodation-in-spain-banner.jpg" alt="Second slide" style="height: 400px; ">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://media.enableholidays.com/file/enablemedia/disabled-holidays-in-spain-banner.jpg" alt="Third slide" style="height: 400px; ">
            </div>
...
<div class="main">
  ...
  <?php
    ...
    <div class='modal-dialog modal-dialog-centered modal-xl' role='document'  >
        ...
        //////////////////////////
        $sql = "SELECT*FROM countryhotels where hotelcountry = 'Spain'";
...
echo"<div class='country' data-aos='fade-up'>
      ...
      <div class=' row info' style='padding: 10px;'>
          <p class='col-8 col-md-8 col-sm-8 col-lg-8' style='font-size: 25px; margin-top: 4px;''>".$row["hotelname"]."</p>";?>
...
<footer class="flex">
    <div class="flex1">
        ...
        <div>
          <a class="linkss" href="">Travel tours</a>
        </div>
        <div>
          <a class="linkss" href="">Vacations</a>
        </div>
    </div>
    <div class="flex2">
        <div>
